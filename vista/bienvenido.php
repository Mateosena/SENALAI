...
<div class="container-entrada">
            <div class="mision">
                <img class="logo" src="../vista/img/LOGO SENA.png" alt="">
            <h1>Misión</h1>
               <p>El SENA está  encargado de cumplir la función que le corresponde al Estado de invertir en el desarrollo social y 
                   ...
                   económico y tecnológico del país.​</p>
                   <h1> Visión</h1>
                   <p>En el 2018 el SENA será reconocido por la efectividad de su gestión, sus aportes al empleo decente y a ​la
