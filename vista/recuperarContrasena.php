...
<head>
    ...
    <link rel="stylesheet" href="../vista/css/bootstrap4.0.0.min.css" 
    integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
    <link href="../vista/css/bootstrap3.3.0.min.css" rel="stylesheet" id="bootstrap-css">
    <link href="../vista/css/bootstrap.min.css" rel="stylesheet" id="bootstrap-css">
...
<img src="../vista/img/senalai.png" class="logo" alt="">
    <div class="container">
                ...
                <div class="d-flex justify-content-center h-100">
                    <div class="card ">
                        ...
                        <div class="card-header">
                            <h2 class="text-center text-light">Recupera tu contraseña</h2>
                            
                        </div>
                        <div class="card-body">
                            <form class="needs-validation" id="formularioRecuperarContrasena">
                                <div class="input-group form-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class='glyphicon glyphicon-user' style='font-size:23px'></i></span>
                                        <input type="password" class="form-control" placeholder="Nueva contraseña" id="Rcontrasena1"  name="Rcontrasena1" >
                                    </div>         
                                </div>
                                <div class="input-group form-group">
                                    <div class="input-group-prepend">
                        ...
                        <div class="card-footer">
                            ...
                            <img class="loading" id="loading" src="../vista/img/loading.gif" alt=""> <span id="mensajeRecuperarContrasena"> </span>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h2 class="modal-title" id="exampleModalLongTitle">Contraseña cambiada correctamente</h2>
        </div>
...
<script src="../ajax/validarRecuperarContrasena.js"></script>
