                ...
                <div class="d-flex justify-content-center h-100">
                    <div class="card ">
                        ...
                        <div class="card-header">
                            <h2 class="text-center text-light">Inicia hentai</h2>
                        </div>
                        <div class="card-body">
                            <form class="needs-validation" id="login">
                                <div class="input-group form-group">
                                    <div class="input-group-prepend">
                                        ...
                                        <input type="text" class="form-control" placeholder="Email O usuario" id="usuario"  name="usuario" >
                                    </div>         
                                </div>
                                <div class="input-group form-group">
                                    <div class="input-group-prepend">
                                    ...
                                    <br>
                                  <label for=""><a class="recuperacontrasena" href="controlador/emailRecuperarContrasena.php">Recuperar Contraseña?</a></label>
...
<script src="ajax/validarLoginUsuario.js"></script>
