                            ...
                            <form class="needs-validation" id="emailformularioRecuperarContrasena">
                                <div class="input-group form-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class='glyphicon glyphicon-envelope' style='font-size:23px'></i></span>
                                    ...
                                    <br>
                                  <label for=""><a class="recuperacontrasena" href="../index.php">Regresar al inicio de Sesión?</a></label>
...
<script src="../ajax/validarEmailRecuperarContrasena.js"></script>
